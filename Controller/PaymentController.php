...
class PaymentController extends PaymentController_parent
{
    ...
    $userinformation=[
        ...
        'testmode'=>($novalnetUtil->backendsettingaccessnncreditcard('nncreditcardtestmode')=='true')?1:0,
        'inline'=>($novalnetUtil->backendsettingaccessnncreditcard('nncreditcardinline')=='true')?1:0,
        'clientkey'=>$novalnetUtil->backendsettingaccess('clientkey'),
    ];
